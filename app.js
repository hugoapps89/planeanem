...
/* ==========================================================
   EXÁMENES — módulo integrado en index.html
   ========================================================== */
if(document.getElementById('examenes')){
/* Plan con IA — Exámenes integrado dentro de index.html */
(() => {
"use strict";
...
const field = $("examField");
const contents = $("examContents");
const pdas = $("examPdas");
...
$("examGenerate").addEventListener("click", () => {
  ...
  const configuredType = $("examType").value;
  ...
  result.innerHTML = `
    ...
    <div class="key">
      ...
      <button class="exam-primary" onclick="window.print()">
